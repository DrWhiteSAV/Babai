...
export default function Leaderboard() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[url('https://picsum.photos/seed/leaderboard/1080/1920?blur=4')] bg-cover bg-center opacity-10 pointer-events-none mix-blend-overlay" />
